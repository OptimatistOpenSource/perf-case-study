...
define internal void @_ZN10chain_refm4main17hb03773e560ea769eE() unnamed_addr #1 personality ptr @rust_eh_personality !dbg !401 {
start:
...
; call perf_case::chain::many_chain_refm
  %a = call fastcc noundef i64 @_ZN9perf_case5chain15many_chain_refm17h3506ece423a3a7c0E(ptr noalias nocapture noundef nonnull align 8 dereferenceable(524288) %state), !dbg !430
  ...
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %_5), !dbg !422
    #dbg_value(ptr @alloc_4fb6d7deade46016b6d47934ff136770, !433, !DIExpression(DW_OP_LLVM_fragment, 0, 64), !536)
  ...
  store ptr @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h57ee16336f259a43E", ptr %_10.sroa.4.0..sroa_idx, align 8, !dbg !422
  ...
  store ptr @alloc_4fb6d7deade46016b6d47934ff136770, ptr %_5, align 8, !dbg !539
