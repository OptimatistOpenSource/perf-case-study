...
define internal void @_ZN9zero_init4main17ha41b1d2bf99608ddE() unnamed_addr #1 personality ptr @rust_eh_personality !dbg !2526 {
start:
...
; call perf_case::zero_init::init_it
  call fastcc void @_ZN9perf_case9zero_init7init_it17hd1189aaa6ae199a2E(ptr noalias nocapture noundef nonnull align 8 dereferenceable(200) %tmp, ptr noalias noundef nonnull readonly align 8 dereferenceable(200) %arr), !dbg !2540
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %_6), !dbg !2537
    #dbg_value(ptr @alloc_c19a00b9f121f42eb6dd92ba9bdb08fc, !2541, !DIExpression(DW_OP_LLVM_fragment, 0, 64), !2641)
  ...
  store ptr @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h146249584b11a94fE", ptr %_11.sroa.4.0..sroa_idx, align 8, !dbg !2537
  ...
  store ptr @alloc_c19a00b9f121f42eb6dd92ba9bdb08fc, ptr %_6, align 8, !dbg !2644
